...
base_dir = "data/images/07_AMZN_RAY"
...
for run in range(1, 6):
    ...
    filename = f"Read_Filter_Write_Ray__amzn23_model_data.parquet___run{run}.csv"
...
if all_dfs:
    ...
    plot_comparison_by_worker_grouped(df_concat, base_dir, "07_AMZN_RAY")
