...
class RayContainerMonitor:
    def __init__(self, state_file="data/state/operation_state_ray.json", output_dir="data/metrics_ray"):
    ...
    def start_monitoring(self, interval=5):
        print(f"[✓] Iniciando monitoreo Ray cada {interval}s...")
        while True:
            try:
